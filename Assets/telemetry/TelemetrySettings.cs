...
{   
    ...
    public string userName = "Username configured on server (no USER_ prefix here)";

    [Tooltip("This helps avoid anyone accidentally writing into the wrong table, and blocks drive-by bot spam.")]
    public string secret = "Passphrase configured on server for this user";
    ...
    [SerializeField] string _serverURL = "https://someserver-id.herokuapp.com/";
    ...
    public NetworkingMode serverCommunication = NetworkingMode.RuntimeOnly;
